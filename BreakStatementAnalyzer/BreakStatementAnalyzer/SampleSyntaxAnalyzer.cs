...
namespace BreakStatementAnalyzer;
...
public class SampleSyntaxAnalyzer : DiagnosticAnalyzer
{
    ...
    public const string CompanyName = "eetrukhan";
    public const string DiagnosticId = "BreakStatementInspection";

    private static readonly DiagnosticDescriptor Rule = new DiagnosticDescriptor(
        DiagnosticId,
        "Avoid 'break' statements outside 'switch'",
        "'break' statement found outside of a 'switch' statement. Consider using alternative control flow.",
        "Control Flow",
        DiagnosticSeverity.Warning,
        isEnabledByDefault: true,
        description: "This rule helps enforce the idiomatic use of 'break' statements in C#.");
