...
using Xunit;
using Verifier =
    Microsoft.CodeAnalysis.CSharp.Testing.XUnit.CodeFixVerifier<BreakStatementAnalyzer.SampleSyntaxAnalyzer,
        BreakStatementAnalyzer.SampleCodeFixProvider>;

namespace BreakStatementAnalyzer.Tests;
